...
<body>
  ...
  <div class="container">
    <div class="text-center" style="background-color: #1f2937;">
      <i class="fas fa-exclamation-circle fa-4x" style="background-color: #1f2937;"></i>
      <h3>Payment Error</h3>
      <p>There was an error processing your payment. Please try again later or contact customer support for assistance.
      </p>
    </div>
